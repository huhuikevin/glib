...
#am__append_1 = $(test_programs) $(test_scripts) $(uninstalled_test_programs) $(uninstalled_test_scripts) \
#         $(dist_test_scripts) $(dist_uninstalled_test_scripts)

#am__append_2 = $(all_test_ltlibs)
#am__append_3 = $(all_test_programs)
#am__append_4 = $(all_test_scripts)
#am__append_5 = $(all_test_data)
am__append_6 = $(all_test_ltlibs)
am__append_7 = $(all_test_programs)
am__append_8 = $(all_test_scripts)
am__append_9 = $(all_test_data)
#am__append_10 = $(test_programs) $(installed_test_programs) \
#                          $(test_extra_programs) $(installed_test_extra_programs)

#am__append_11 = $(test_scripts) \
...
#am__append_12 = $(test_data) \
#	$(installed_test_data) \
#	$(dist_test_data) \
#	$(dist_installed_test_data)
#am__append_13 = $(test_ltlibraries) $(installed_test_ltlibraries)
#am__append_14 = $(installed_test_meta_DATA)
am__append_15 = check-abis.sh
am__append_16 = gio-unix-2.0.pc
#am__append_17 = gio-windows-2.0.pc
subdir = .
...
ACLOCAL = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/missing autoconf
AUTOHEADER = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/missing autoheader
AUTOMAKE = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/missing automake-1.15
AWK = gawk
CARBON_LIBS = 
...
CYGPATH_W = echo
DATADIRNAME = share
DBUS1_CFLAGS = -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include 
DBUS1_LIBS = -ldbus-1 
...
GMSGFMT = /works/tools/user/bin/msgfmt
GREP = /bin/grep
GSPAWN = gspawn.lo
...
LT_REVISION = 2
MAINT = 
MAKEINFO = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MKINSTALLDIRS = ./mkinstalldirs
MSGFMT = /works/tools/user/bin/msgfmt
MSGFMT_OPTS = -c
...
PACKAGE_NAME = glib
PACKAGE_STRING = glib 2.46.2
PACKAGE_TARNAME = glib
PACKAGE_URL = 
PACKAGE_VERSION = 2.46.2
PATH_SEPARATOR = :
PCRE_CFLAGS = 
PCRE_LIBS = 
PCRE_REQUIRES = 
...
WSPIAPI_INCLUDE = 
XATTR_LIBS = 
XGETTEXT = /works/tools/user/bin/xgettext
XMLCATALOG = /usr/bin/xmlcatalog
XML_CATALOG_FILE = /etc/xml/catalog
XSLTPROC = /usr/bin/xsltproc
ZLIB_CFLAGS = 
ZLIB_LIBS = -L/usr/lib/x86_64-linux-gnu -lz 
abs_builddir = /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2
abs_srcdir = /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2
abs_top_builddir = /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2
abs_top_srcdir = /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = c++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /disk2/sources/zhw/kevin/imx-android/external/glib-2.46.2/install-sh
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/glib.mk $(am__configure_deps)
	@for dep in $?; do \
...
installdirs-am:
	for dir in "$(DESTDIR)$(installed_testdir)" "$(DESTDIR)$(installed_testdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(installed_testdir)" "$(DESTDIR)$(installed_test_metadir)" "$(DESTDIR)$(installed_testdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
uninstall-am: uninstall-binSCRIPTS uninstall-installed_testLTLIBRARIES \
	uninstall-installed_testPROGRAMS \
	uninstall-installed_testSCRIPTS \
	uninstall-installed_test_metaDATA \
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	uninstall-binSCRIPTS uninstall-installed_testLTLIBRARIES \
	uninstall-installed_testPROGRAMS \
	uninstall-installed_testSCRIPTS \
	uninstall-installed_test_metaDATA \
	uninstall-nobase_installed_testDATA uninstall-pkgconfigDATA
